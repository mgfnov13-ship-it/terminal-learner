  ...
  filesLesson(
    ...
    [
      ...
      },
      {
        id: 'f11-summary',
        kind: 'summary',
        title: 'Files track complete',
        body: 'You can list, create, navigate, name paths, make files, rename, copy, move, and delete. Later tracks will use these same habits on bigger jobs.',
      },
    ],
  ),
];
